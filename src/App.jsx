    ...
    <section id="our-partners" className="relative py-12 bg-gradient-to-b from-[#0f0003] to-[#170007] text-ivory-warm border-t border-gold/20">
      <div className="relative max-w-5xl mx-auto px-4">
        ...
        <div className="reveal text-center mb-8">
          ...
          <h2 className="font-display text-2xl md:text-3xl font-bold text-ivory-warm mt-2">
            Sponsors &amp; Co-Sponsors
          </h2>
          <div className="mt-2 mx-auto h-0.5 w-20 rounded-full bg-gradient-to-r from-transparent via-gold to-transparent" />
        </div>
